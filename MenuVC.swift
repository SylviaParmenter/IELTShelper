...
class MenuVC: UIViewController,MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        rowList = [[("Display",""),("Reminder",switchValue)],[("App Store review",""),("Send feedback","")],[("Open Source Libraries","")]]
        setTableView()
    ...
    func sendEmail() {
        if MFMailComposeViewController.canSendMail() {
            ...
            mail.setToRecipients(["ciman1415108@mail.ru"])
        ...
        case 1:
            if indexPath.row == 0 {
                if #available(iOS 10.3, *) {
                    ...
                    let str = "itms-apps://itunes.apple.com/app/id1479811164?action=write-review"
